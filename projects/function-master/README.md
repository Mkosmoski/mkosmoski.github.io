...
## Review Questions from Module One Handbook?
 - what can we `typeof` ? number string boolean
 - what can't we `typeof` ? arrays, null, objects, date
 - how do we check those things? using if statements
 - Array.isArray() - array
 - null === null -null 

## Standard Library Methods You Should Know By Now:
 - Object.keys() - access value of keys 
 - String.toUpperCase() - uppercase strings
