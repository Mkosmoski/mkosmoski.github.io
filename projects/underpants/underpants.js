...
//function with the params array and number
...
_.indexOf = function(array, value){ // return the index of array
...
_.reject = function(bigArray, isFunc) {
  let smallArray = []
  _.each(bigArray, function(value, index, list){
      smallArray.push(bigArray[index])
  })
  
   let newArray = _.filter(smallArray, isFunc) // returns elements that are 'true'
