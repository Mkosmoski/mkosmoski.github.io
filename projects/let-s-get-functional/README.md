...
## Step 1 - Setup
 ...
 - Copy the name of your `lodown`package. It should be something like `lodown-megankosmo`
 - In your bash terminal run the command `npm install --global lodown-megankosmo` with **your** lodown package
 - In your bash terminal run the command `npm link lodown-megankosmo` with **your** lodown package
