...
function greeter(hour) {
    ...
    // if function to call good morning! to console.log() if its earlier than 11
    if (hour <= 11){
        console.log("Good Morning!");
    // console.log() good afternoon if its between 12-16
    } else if (hour > 11 && hour < 17) {
        console.log("Good Afternoon!");
    // console.log good evening if its between 17-21
    }else if (hour > 16 && hour <= 21) {
        console.log("Good Evening!");
    // console.log good night if hour is between 20-24
