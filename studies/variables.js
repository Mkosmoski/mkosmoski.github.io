 ...
 * It is good practice to name your variable something that describes how or 
 * why you are using it! It will help your code be easier to read.
 */
console.log(myName); // prints => undefined

// 2. initialization or assignment //
/*
* Giving your variable value is called intializing it. If you do not initialize 
* your variable will remain undefined until you do
*/
myName = 'john';
...
// 3. re-assignment //
/*
* Variables declared with var or let can be reassigned. To do so simply write 
* it in a new statement. Remember that once you have reassigned that variable 
* your new value will only effect the code after the new assignment
*/
myName = 'bob';
...
myVariable = "someString"; // reassigned myVariable


//4.0 var vs let vs const
/*
* In javascript ES6 you can also use let and const to declare variables. 
* var, let, and const have differences in how they will work and be read in 
* your code
*/
...
* 1. hoisted- the declaration of a variable is brought to the top of the code
* when the JS interpreter starts to read the code (more info in hoisted section)
* 2. scoped to functions - when declared in a function they stay in the 
* function, but var is not scoped to blocks, you can access the var outside of 
* the code blocks of loops or if statements (more info in the scope section)
*/
...
// robotName = "hal"; will not re assign robotName, robotName will remain
// "sparky" because it is a constant

//5. Hoisting
/*
* hoisting is when a variable it brought to the top of the program or code block.
* all var and function declarations are brought to the top once a program is 
* executed.
* 
